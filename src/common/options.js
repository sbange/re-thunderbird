...
var cssEdit, cssSyntaxEdit, cssSyntaxSelect, rawMarkdownIframe, savedMsg,
    ...
    reserver, apikey, alwaysre, loaded = false;
...
function onLoad() {
  ...
  alwaysre = document.getElementById('alwaysre');
  ...
  */
  ...
  OptionsStore.get(function(prefs) {
    ...
    */
    reserver.value = prefs['reserver'];
    apikey.value = prefs['apikey'];
    alwaysre.checked = prefs['alwaysre'];
...
function checkChange() {
  var newOptions =
        ...
        apikey.value + reserver.value + alwaysre.checked;
...
// TODO sb save our values
document.getElementById('resave').addEventListener('click', resave, false);
function resave() {
  OptionsStore.set(
    {
      'reserver': reserver.value,
